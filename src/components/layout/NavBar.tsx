...
export default function NavBar() {
    ...
    return (
        <div className="fixed top-0 z-[9999] flex h-14 w-full place-content-between place-items-center border-b-[1.5px] border-zinc-300 bg-white px-8 xl:px-32">
            ...
            <div className="flex gap-4">
                ...
                <Button
                    className="w-24 border-none bg-brand-400 font-normal outline-none"
